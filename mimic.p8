...
function init_tiles_and_actors(l)
    for i=0,level_size-1 do
        ...
        for j=0,level_size-1 do
            ...
            level_dynamic_tiles[i][j] = make_tile(dynamic_spr)
            level_static_tiles[i][j] = make_tile(static_spr)
        end
    end
end
...
function update_tutorial()
    ...
    if game.tick % tutoriapeed == 0 then
...
__gff__

...

